...
import HomeCard from './Components/Reusables/HomeCard';
...
function App() {
  ...
  return (
    <Fragment>
      <div id="titleMenu" className="w-100 d-flex justify-content-center text-white position-fixed" style={{ backgroundColor: '#00000082', zIndex: 1000 }}>
      ...
      <div id="textContent">
        <div className="container d-flex justify-content-center align-items-center flex-wrap p-4">
          <HomeCard
            ...
            backgroundImage='./assets/magic.png'
            alt='magic_book'
          ...
          <HomeCard
            ...
            backgroundImage='./assets/global.png'
            alt='earth'
          ...
          <HomeCard
            ...
            backgroundImage='./assets/pencil.png'
            alt='editor'
          ...
          <div className="w-100 d-flex flex-wrap align-items-center" style={{ backgroundColor: '#251c3b' }}>
            <div className={(innerWidth < 1000 ? 'w-100' : 'w-50 h-100')}>
              <div className={(innerWidth < 1000 ? 'd-flex justify-content-center' : '') + " p-4"}>
                <img src="./assets/moon.png" alt="moon" width={innerWidth < 1000 ? '250px' : '500px'} height={innerWidth < 1000 ? '250px' : '500px'} />
              </div>
            </div>
